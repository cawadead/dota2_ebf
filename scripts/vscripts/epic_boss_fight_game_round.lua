...
function CHoldoutGameRound:Begin()
	...
	elseif roundNumber == 10 then
		...
		if GameRules._NewGamePlus == true then
			...
			GameRules:GetGameModeEntity():SetInnateMeleeDamageBlockAmount( 750 )
			GameRules:GetGameModeEntity():SetInnateMeleeDamageBlockPerLevelAmount( 100 )
	...
	elseif roundNumber == 20 then
		if GameRules._NewGamePlus == true then
			...
			GameRules:GetGameModeEntity():SetInnateMeleeDamageBlockAmount( 5000 )
			GameRules:GetGameModeEntity():SetInnateMeleeDamageBlockPerLevelAmount( 1000 )
			GameRules:GetGameModeEntity():SetInnateMeleeDamageBlockPercent( 50 )
		end
	elseif roundNumber == 30 then
		if GameRules._NewGamePlus == true then
			...
			GameRules:GetGameModeEntity():SetInnateMeleeDamageBlockAmount( 10000 )
			GameRules:GetGameModeEntity():SetInnateMeleeDamageBlockPerLevelAmount( 2500 )
			GameRules:GetGameModeEntity():SetInnateMeleeDamageBlockPercent( 50 )
		end
	end
...
function CHoldoutGameRound:IsFinished()
	...
	for _, unit in ipairs( FindAllUnits({}) ) do
		if unit:GetTeam() == DOTA_TEAM_BADGUYS and unit:IsAlive() and unit:GetHealth() > 0 then
			return false
		end
	end
