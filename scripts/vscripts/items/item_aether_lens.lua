...
function modifier_item_aether_lens_ebf:OnCreated()
	...
	self.bonus_other = self:GetAbility():GetSpecialValueFor("bonus_agi_str")
...
function modifier_item_aether_lens_ebf:GetModifierBonusStats_Strength()
...
function modifier_item_aether_lens_ebf:GetModifierBonusStats_Agility()
	return self.bonus_other
end
...
function modifier_item_aether_lens_ebf:GetModifierSpellAmplify_PercentageUnique()
